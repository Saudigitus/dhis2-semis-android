...
fun SearchableDropdown(
    ...
    Column {
        ...
        AnimatedVisibility(isExpanded && !field.optionSet.isNullOrEmpty()) {
            DropdownMenu(
                expanded = isExpanded && !field.optionSet.isNullOrEmpty(),
                ...
                field.optionSet?.forEachIndexed { index, item ->
                    DropdownMenuItem(
                        text = { Text(text = "$item") },
                        onClick = {
                            selectedIndex = index
                            ...
                            onItemClick.invoke(item.code.orEmpty())
                        },
                        modifier = Modifier
                            .fillMaxSize()
                            .background(

...
import org.saudigitus.campaign.core.designsystem.theme.light_info
    ...
    var selectedDate by remember {
        mutableStateOf(
            DateHelper.formatDate(
               date ?:  datePickerState.selectedDateMillis ?: DateUtils.getInstance().today.time,
            ).orEmpty(),
        )
    }
    ...
    if (show) {
        DatePickerDialog(
            ...
            colors = DatePickerDefaults.colors(
                ...
                todayContentColor = SurfaceColor.Primary,
